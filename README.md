...
* Write requests:
  ...
  - 8.5 * 10^8 / 24 / 60 / 60 = 12'150 rps

* RPS по типам:
  
  * Отправка сообщения: 7 * 10^6 * (150) /  24 / 60 / 60 = 12150 RPS
  
  * Получение сообщения: 7 * 10^6 * (150) / 24 / 60 / 60 = 12150 RPS
  
  * Получение списка чатов : 7 * 10^6 * (25) / 24 / 60 / 60 = 2050 RPS
  
  * Получение дельты списка чатов: 7 * 10^6 * 50 / 24 / 60 / 60 = 4100 RPS
  
  * Просмотр диалога: 7 * 10^6 * 300 / 24 / 60 / 60 = 24'300 RPS
  
  * Просмотр истории диалога: 7 * 10^6 * 25 / 24 / 60 / 60 = 2025 RPS
...
* Peak PRS: 170'250
  ...
  * Write RPS: 36'450
    ...
    - Получение сообщения: 36450 RPS
    
    - Получение списка чатов:  6150 RPS
    
    - Получение дельты списка чатов:  12300 RPS
    
    - Просмотр диалога: =72'900 RPS
    
    - Просмотр истории диалога: 6075 RPS
